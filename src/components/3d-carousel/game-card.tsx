...
const GameCard = ({ active, setActive, project }: GameCardProps) => {
  ...
  const headerClipPath = `[clip-path:polygon(0_0,_0_100%,_130px_100%,_165px_43px,_100%_43px,_100%_0)]`;
  const descClipPath = `[clip-path:polygon(0_25px,_180px_25px,_215px_0,_100%_0,_100%_100%,_0_100%)]`;
  const footerClipPath = `[clip-path:polygon(0_0,_0_100%,_100%_100%,_100%_25px,_30%_25px,_21%_0)]`;
    ...
    >
      <DialogContent className={supplyMono.className}>
        ...
        <div className="relative">
          ...
          <div className="absolute left-[50%] top-[50%] z-50 flex h-[75vh] min-h-[600px] w-full max-w-lg translate-x-[-50%] translate-y-[-50%] flex-col gap-3 rounded border bg-[var(--background)] p-6 shadow-lg sm:w-96">
            {/* Title / Header */}
            <DialogHeader
            ...
            {/* Image */}
            <div className="h-52 w-full rounded border" />

            {/* Description */}
            <div className={`grow ${descClipPath} bg-red-950`}>
              <p className="pb-3 text-right text-lg text-muted-foreground">
                Description
              </p>
            ...
            {/* Stack / Footer */}
            <div className={`px-2 py-1 ${footerClipPath} ${bgGradientTr}`}>
              <p className="px-1 pb-4 text-lg text-muted-foreground">Stack</p>
